...
Pod::Spec.new do |s|
  s.name             = 'CTCocoaPods'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CTCocoaPods.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tianwenshi/CTCocoaPods'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tianwenshi' => 'lancelot.tian@yeahmobi.com' }
  s.source           = { :git => 'https://github.com/tianwenshi/CTCocoaPods.git', :tag => s.version.to_s }
